...
HD_PWD='C:/Users/User/Desktop/STM/Lab3/Array_Multiplier/Array_Multiplier/Array_Multiplier.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log array_mul.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source array_mul.tcl
