...
HD_PWD='C:/Users/User/Desktop/STM/Lab3/Array_Multiplier/Array_Multiplier/Array_Multiplier.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log array_mul.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source array_mul.tcl -notrace
